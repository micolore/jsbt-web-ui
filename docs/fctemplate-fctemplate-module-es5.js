...
var UtilService = /** @class */ (function () {
     ...
     * @param calc 减去高度
     */
    UtilService.fixedTableHeader = function (calc) {
        var y = document.body.clientHeight - calc;
...
var FctemplatelistComponent = /** @class */ (function () {
    function FctemplatelistComponent(router, activedRoute) {
        this.router = router;
        this.activedRoute = activedRoute;
        this.listOfData = [];
        this.controlArray = [];
     ...
     * @param event
     */
    FctemplatelistComponent.prototype.onResize = function (event) {
...
var FctemplatetreelistComponent = /** @class */ (function () {
    ...
    FctemplatetreelistComponent.prototype.ngOnInit = function () {
        for (var i = 0; i < 100; i++) {
            this.listOfData.push({
                name: "Edward King " + i,
                age: 32,
    ...
    FctemplatetreelistComponent.prototype.nzEvent = function (event) {
        console.log(event);
    };
    /**
    * 改变浏览器窗口大小
    * @param event
    */
    FctemplatetreelistComponent.prototype.onResize = function (event) {
        this.tableScroll = src_fccore_util_util_service__WEBPACK_IMPORTED_MODULE_3__["UtilService"].fixedTableHeader(300);
    };
