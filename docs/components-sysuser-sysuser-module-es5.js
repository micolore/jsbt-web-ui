 ...
 */
var SysuserBusiness = /** @class */ (function () {
    function SysuserBusiness(http) {
        this.http = http;
    }
    SysuserBusiness.ctorParameters = function () { return [
...
var SysuserComponent = /** @class */ (function () {
    function SysuserComponent(router, activedRoute, sysuserBusiness) {
        this.router = router;
    ...
    SysuserComponent.ctorParameters = function () { return [
...
var SysuserModule = /** @class */ (function () {
    function SysuserModule() {
    }
...
//# sourceMappingURL=components-sysuser-sysuser-module-es5.js.map