...
var AppRoutes = [
    {
        ...
        children: [
            ...
            {
                path: 'fc',
                loadChildren: function () { return __webpack_require__.e(/*! import() | feature-fc-fc-module */ "feature-fc-fc-module").then(__webpack_require__.bind(null, /*! ../feature/fc/fc.module */ "./src/feature/fc/fc.module.ts")).then(function (res) { return res.FcModule; }); }
            }
        ]
    },
    {
...
var SyseditpasswordComponent = /** @class */ (function () {
    function SyseditpasswordComponent(fb, subject) {
        var _this = this;
        this.fb = fb;
        ...
        //验证旧密码
        this.formatOldValidator = function (control) {
            if (!control.value) {
                _this.oldPasswordExplain = '旧密码不能为空！';
         ...
         */
        this.formatValidator = function (control) {
            var regExp = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[\=\,\.\?\|\(\)\{\}\[\#\@\`\~\!\<\>\;\:\'\"\_\&\%\]\*\/\\\+\^\$\-]).{6,16}$/;
            if (!control.value) {
                _this.newPasswordExplain = '新密码不能为空！';
                return { format: true }; // 验证不能为空
            }
            else if (!regExp.test(control.value)) {
                _this.newPasswordExplain = '请输入6-16位密码，且必须包含字母、数字、特殊字符、区分大小写！';
                return { format: true, error: true };
            }
            else if (control.value == _this.validateForm.controls['oldPassword'].value) {
                _this.newPasswordExplain = '新旧密码不能一致';
                return { format: true, error: true };
            }
        };
        /**
         ...
         * @memberof EdituserComponent
         */
        this.confirmNewPwdValidator = function (control) {
            if (!control.value) {
                return { required: true }; // 验证不能为空
            }
            else if (control.value !== _this.validateForm.controls['newPassword'].value) {
                _this.confirmPasswordExplain = '两次输入的密码不一致';
                return { confirm: true, error: true };
            }
        };
    }
    SyseditpasswordComponent.prototype.ngOnInit = function () {
        // 表单验证
    ...
    * @param name
    */
    SyseditpasswordComponent.prototype.getFormControl = function (name) {
     ...
     *确定
     */
    SyseditpasswordComponent.prototype.handleOk = function () {
     ...
     *取消
     */
    SyseditpasswordComponent.prototype.handleCancel = function () {
        this.subject.destroy('onCancel');
    };
    SyseditpasswordComponent.ctorParameters = function () { return [
    ...
    return SyseditpasswordComponent;
}());
...
var LayoutComponent = /** @class */ (function () {
    function LayoutComponent(router, activatedRoute, mainService, shareService, modalService, message) {
        var _this = this;
        this.router = router;
        ...
        this.fcTabs = [];
        // 点击左侧导航
        src_fccore_service_common_service__WEBPACK_IMPORTED_MODULE_7__["CommonService"].subscribe('selectedMenu', function (event) {
            if (event) {
     ...
     * 修改密码
     */
    LayoutComponent.prototype.editPassWord = function () {
     ...
     * 清除缓存
     */
    LayoutComponent.prototype.clearCache = function () {
...
var LayoutService = /** @class */ (function () {
    function LayoutService(messageService) {
...
var FcRouteReuseStrategy = /** @class */ (function () {
    ...
    FcRouteReuseStrategy.prototype.shouldReuseRoute = function (future, curr) {
        ...
        if (path.length > 0 && ~path.indexOf(':')) {
            var futureUrl = this.getRouteUrl(future);
            var currUrl = this.getRouteUrl(curr);
...
var Fcg2barComponent = /** @class */ (function () {
    function Fcg2barComponent() {
    }
    // 初始化组件视图和子视图后调用，只调用一次 ， 可以进行dom操作
    Fcg2barComponent.prototype.ngAfterViewInit = function () {
        this.createChartBar(this.fcId, this.fcData);
        // 自适应宽度
        this.chartBar.forceFit();
    };
    Fcg2barComponent.prototype.createChartBar = function (id, data) {
...
var Fcg2linerComponent = /** @class */ (function () {
    function Fcg2linerComponent() {
    }
    Fcg2linerComponent.prototype.ngAfterViewInit = function () {
    ...
    /**
       ...
       * @param data
       */
    Fcg2linerComponent.prototype.createChartLine = function (containerId, data) {
...
var Fcg2minibarComponent = /** @class */ (function () {
    function Fcg2minibarComponent() {
    }
    Fcg2minibarComponent.prototype.ngAfterViewInit = function () {
   ...
   * @param sum
   */
    Fcg2minibarComponent.prototype.createMiniBarChart = function (containerId, data, sum) {
...
var Fcg2pieComponent = /** @class */ (function () {
    function Fcg2pieComponent() {
    }
    Fcg2pieComponent.prototype.ngAfterViewInit = function () {
        this.createChartPie();
    };
    Fcg2pieComponent.prototype.createChartPie = function () {
        var data = [{
                type: '评估中',
                percent: 0.23
            }, {
        ...
        var sum = 500;
        var ds = new _antv_data_set__WEBPACK_IMPORTED_MODULE_3___default.a();
        var dv = ds.createView().source(data);
        dv.transform({
            type: 'map',
            callback: function callback(row) {
                var res = sum * row.percent + '';
        ...
        chart.intervalStack().position('percent').color('type', ['#0a7aca', '#0a9afe', '#4cb9ff', '#8ed1ff']).opacity(1).label('percent', {
            ...
            formatter: function formatter(text, item) {
                var res = item.point.percent * 100 + '';
...
var Fcg2radarComponent = /** @class */ (function () {
    function Fcg2radarComponent() {
    }
    Fcg2radarComponent.prototype.ngAfterViewInit = function () {
     ...
     * @param {data}数据
     */
    Fcg2radarComponent.prototype.createRadarChart = function (containerId, data) {
        var _DataSet = new _antv_data_set__WEBPACK_IMPORTED_MODULE_2___default.a();
...
var FcimgviewComponent = /** @class */ (function () {
    ...
    FcimgviewComponent.ctorParameters = function () { return [
...
var Fcverifycode = /** @class */ (function () {
    ...
    Fcverifycode.prototype.Constructor = function () {
    };
    Fcverifycode.prototype.ngOnInit = function () {
        this.draw([]);
        console.log(this.validVerifyCode);
    };
    //生成并渲染出验证码图形
    Fcverifycode.prototype.draw = function (show_num) {
        var elem = this.canvasRef.nativeElement;
        console.dir(elem);
        // let canvas_width = elem.offsetWidth;
        // let canvas_height = elem.offsetHeight;
        var canvas_width = 100;
        var canvas_height = 30;
        var canvas = elem; //获取到canvas的对象，演员
    ...
    //得到随机的颜色值
    Fcverifycode.prototype.randomColor = function () {
     ...
     * 监测输入值是否正确
     */
    Fcverifycode.prototype.changeValue = function (event) {
...
var FCCONFIG = src_environments_environment_dev__WEBPACK_IMPORTED_MODULE_3__["environment"];
var DaoService = /** @class */ (function () {
    ...
    DaoService.ctorParameters = function () { return [
...
var isDev = !src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].production;
var LogService = /** @class */ (function () {
    function LogService(daoService, cacheService) {
        this.daoService = daoService;
        this.cacheService = cacheService;
    }
    LogService.debug = function (msg, describtion) {
        if (isDev) {
...
var SysforgotComponent = /** @class */ (function () {
    function SysforgotComponent(router) {
        this.router = router;
    }
    SysforgotComponent.prototype.ngOnInit = function () {
    };
    SysforgotComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var PROJECT_NAME = src_environments_environment_dev__WEBPACK_IMPORTED_MODULE_3__["environment"].projectName;
var SyssigninComponent = /** @class */ (function () {
    function SyssigninComponent(router) {
        this.router = router;
        this.hasError = false;
        this.msg = '用户名或者密码错误';
        this.userId = '';
    ...
    SyssigninComponent.prototype.ngOnInit = function () {
     ...
     */
    SyssigninComponent.prototype.login = function () {
    ...
    SyssigninComponent.prototype.loginValid = function (userId, password) {
    ...
    SyssigninComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('verifyCode', { static: true }),
...
var SyssignupComponent = /** @class */ (function () {
    function SyssignupComponent(router, fb) {
        this.router = router;
        this.fb = fb;
        this._projectName = src_environments_environment_dev__WEBPACK_IMPORTED_MODULE_4__["environment"].projectName;
    }
    SyssignupComponent.prototype.ngOnInit = function () {
        this.validateForm = this.fb.group({
            uname: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            password: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
        });
    };
    SyssignupComponent.prototype.getFormControl = function (name) {
        return this.validateForm.controls[name];
    };
    SyssignupComponent.ctorParameters = function () { return [
...
function forbiddenNameValidator(reg) {
    return function (control) {
        if (control.value && control.value.length === 4) {
            var forbidden = !reg.test(control.value); // 用于检测一个字符串是否匹配某个模式
