...
var Routers = [
    ...
    {
        path: '',
        loadChildren: function () { return __webpack_require__.e(/*! import() | fcdemo-fcdemo-module */ "fcdemo-fcdemo-module").then(__webpack_require__.bind(null, /*! ./fcdemo/fcdemo.module */ "./src/feature/fc/fcdemo/fcdemo.module.ts")).then(function (res) { return res.FcdemoModule; }); }
    },
    {
        path: '',
        loadChildren: function () { return __webpack_require__.e(/*! import() | fcsystem-fcsystem-module */ "fcsystem-fcsystem-module").then(__webpack_require__.bind(null, /*! ./fcsystem/fcsystem.module */ "./src/feature/fc/fcsystem/fcsystem.module.ts")).then(function (res) { return res.FcsystemModule; }); }
    }
];
